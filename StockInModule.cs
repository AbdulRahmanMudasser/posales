    ...
    public partial class StockInModule : Form
    {
        ...
        private void cboSupplier_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Display User that an Unexpected Exception has Occurred
                MessageBox.Show("An Unexpected Exception has Occurred while Loading Suppliers in Combo Box" + ex.Message);
            }
        }
        ...
        public void loadStockIn()
        {
            ...
            catch (Exception ex)
            {
                ...
                // Display User that an Unexpected Exception has Occurred
                MessageBox.Show("An Unexpected Exception has Occurred while Stock In Record" + ex.Message);
            }
        }
        ...
        private void btnEntry_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                // Display User that an Unexpected Exception has Occurred
                MessageBox.Show("An Unexpected Exception has Occurred while Saving New Stock In Record" + ex.Message);
            }
        }
            ...
            if (databaseOperation == "Delete")
            {
                if (MessageBox.Show("Remove This Stock In Record?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        // Display User that an Unexpected Exception has Occurred
                        MessageBox.Show("An Unexpected Exception has Occurred while Deleting Stock In Record" + ex.Message);
                    }
                }
            }
        }
